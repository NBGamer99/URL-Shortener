                ...
                >
                    <div>
                        <div class="flex items-center justify-center space-x-3">
                            ...
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="h-6 w-6 mx-6 text-gray-500"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                                stroke-width="2"
                        ...
                        <p
                            class="mt-4 w-45 text-gray-500 dark:text-gray-400 text-sm leading-relaxed"
                        >
                            Congratulations! If you're reading this, it means
                            you've mastered the art of summoning the holy
                            trinity of Laravel, Vite, and Vue. You've officially
                            joined the elite league of web development wizards.
                            Prepare to embark on a magical journey filled with
                            code spells and wizardry bugs!
                        </p>
                    </div>
                </div>
            </div>
            ...
            >
                ...
                >
                    <div class="flex items-center gap-4">
                        <a
                            href="https://github.com/NBGamer99"
