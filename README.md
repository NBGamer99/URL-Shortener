...
1. **PHP:** Install PHP 8.2.5 or higher on your machine. You can refer to the [PHP installation documentation](https://www.php.net/manual/en/install.php) for detailed instructions.

2. **Composer:** Install Composer globally on your system. Visit the [Composer website](https://getcomposer.org/) for installation instructions specific to your operating system.

3. **Node.js and npm:** Install Node.js and npm by following the instructions provided in the [official Node.js documentation](https://nodejs.org/). Choose the version suitable for your operating system.
...
4. **MariaDB:** Install and set up MariaDB on your system. Here are the general steps:
   ...
   - For Windows:
     - Download the MariaDB installer from the [official MariaDB website](https://mariadb.org/download/).
...
6. Edit the `.env` file to match your environment.
	...
	> **Optional `Maildev` Setup :**
	To use Maildev as a testing tool, it is recommended to modify the following settings in your .env file
...
4. Install PHP dependencies:
   ...
   composer install
   ```
5. Create a `.env` file. You can do this manually or use the Command Prompt:
   ```powershell
...
6. Generate a new application key:
   ...
   php artisan key:generate
   ```
7. Edit the `.env` file and update the database connection settings to match your environment.
	> **Optional `Maildev` Setup :**
	To use Maildev as a testing tool, it is recommended to modify the following settings in your .env file
	```dosini
	MAIL_HOST=localhost
